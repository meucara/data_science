...
Följande träd visar projektets uppbyggnad. Det rekommenderas att läsa filerna i den ordning de listas nedan för att bäst förstå dataflödet.
...
│
└── pages/                    # Presentationslager (rena sidor som anropar funktioner)
    ├── streamlit.py          # Introduktion, syfte och bakgrund till projektet.
    ├── data_cleaning.py      # Pedagogisk genomgång av hur datan har tvättats.
